...
MATERIAL_CODE_LABELS = MappingProxyType(
    {
        ...
        "XR": ("Relais duplex radio (émetteur-récepteur)", "Relais instantanés autres que définis dans ce tableau (répétiteurs..)"),
...
SENSOR_ANALOG_BIGRAMS = frozenset(
    {"MA", "MC", "MD", "ME", "MF", "MG", "MH", "MI", "MJ", "ML", "MM", "MN", "MP", "MQ", "MR", "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ"}
)
SENSOR_TOR_BIGRAMS = frozenset(
    {"SA", "SC", "SD", "SE", "SF", "SG", "SH", "SI", "SJ", "SK", "SL", "SM", "SN", "SP", "SR", "SS", "ST", "SU", "SV", "SX", "SY", "SZ"}
)
...
MATERIAL_QUALIFIER_HINTS = MappingProxyType(
    {
        ...
        "BN": MappingProxyType({"D": "Raccordements divers", "E": "Electrique", "I": "Informatique", "T": "Raccordement PTT"}),
        "BC": MappingProxyType({"D": "Raccordements divers", "E": "Electrique", "I": "Informatique", "T": "Raccordement PTT"}),
        "PJ": MappingProxyType({"D": "Raccordements divers", "E": "Electrique", "I": "Informatique", "T": "Raccordement PTT"}),
        "DT": MappingProxyType({"H": "Hyper fréquence", "I": "Infrarouge", "J": "Incendie"}),
        "CE": MappingProxyType({"C": "Condensateur", "D": "Diode ou thyristor", "L": "Self ou inductance", "R": "Résistance, potentiomètre ou shunt", "T": "Télérupteur"}),
        "HE": MappingProxyType({"C": "Chromatographe", "K": "Convertisseur électrique ou changeur de fréquence", "O": "Oscilloperturbographe", "T": "Tachyperturbographe"}),
        "HT": MappingProxyType({"B": "Recherche de personnes / beeper", "G": "Généphone", "I": "Interphone", "L": "Haut parleur", "M": "Microphone", "T": "Téléphone", "Y": "Radio / talkie walkie", "Z": "Téléphone de sûreté"}),
        ...
        "FI": MappingProxyType({"A": "Filtre de très haute efficacité (absolu)", "D": "Filtre provisoire / filtre de démarrage", "F": "Filtre de très haute efficacité (fin)", "I": "Piège à iode", "P": "Filtre de moyenne efficacité (préfiltre)"}),
        "JO": MappingProxyType({"E": "Joint d'étanchéité à presse étoupe", "G": "Joint d'étanchéité à garniture mécanique", "I": "Joint isolant", "J": "Joint plein"}),
        "BA": MappingProxyType({"B": "Ballon", "N": "Bouteille de niveau", "P": "Trou d'homme", "T": "Bouteille tampon sur prise de pression"}),
        ...
        "BZ": MappingProxyType({"C": "Caisson de batterie froide", "F": "Caisson de filtre", "H": "Caisson de réchauffeur"}),
        "AS": MappingProxyType({"A": "Absorbant", "C": "Couverture", "E": "Protection / écran", "F": "Combustible", "K": "Assemblage avec absorbant consommable", "L": "Restricteur de flux", "M": "Modérateur", "N": "Plénum", "R": "Réflecteur", "S": "Source de neutron", "X": "Assemblage spécial"}),
        "RX": MappingProxyType({"C": "Consignation", "E": "Essai", "I": "Intervention immédiate", "R": "Réquisition", "T": "Exceptionnel de travaux", "X": "Exploitation et lignage"}),
...
def describe_extension(material_code: str, extension: str) -> tuple[str, ...]:
    ...
    if bigram in {"TY", "GL"} and len(extension) == 4:
        component_names = {"C": "Cintre", "E": "Coude", "L": "Piquage", "S": "Point de supportage ou de fixation", "T": "Té"}
